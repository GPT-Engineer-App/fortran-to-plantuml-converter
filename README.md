# fortran-to-plantuml-converter

以下は、fortran77コードをPlantUMLコードにするPythonコードです。このコードを添削してDo～Continue分と継続行をサポートするコードにしてください。
...
```sh
git clone https://github.com/GPT-Engineer-App/fortran-to-plantuml-converter.git
cd fortran-to-plantuml-converter
npm i
```
